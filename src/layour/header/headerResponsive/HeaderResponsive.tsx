...
const HeaderResponsive = () => {
  ...
  useEffect(() => {
    const handleOutsideClick = (event) => {
      if (isMenuOpen && !event.target.closest(`.${style.sidebar}`) && !event.target.closest(`.${style.header_barIcon}`)) {
        setIsMenuOpen(false);
      }
    };
...
<div className="container">
    ...
    <div className={`${style.sidebar} ${isMenuOpen ? style.open : ""}`}>
        <div className={style.sideBar_head}>
            ...
            <li className={style.sideBar_head_li}>Shop <MdKeyboardArrowRight className={style.sideBar_head_li_icon}/></li>
            <li className={style.sideBar_head_li}>Abouts</li>
            <li className={style.sideBar_head_li}>Models <MdKeyboardArrowRight className={style.sideBar_head_li_icon}/></li>
